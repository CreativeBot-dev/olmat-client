...
export default async function TransactionPage({
  ...
  // Fungsi untuk mengonversi tanggal ke format lokal user
                ...
                {statusNow === "paid" ? (
                  <div className="flex justify-center w-full mx-auto mb-4">
                    <div className="p-4 text-center space-y-4">
                      ...
                      <p className="">
                        Terimakasih, pembayaran peserta Olimpiade Matematika
                        UINSA sudah kami terima.
                      </p>
                    </div>
                  </div>
                ) : statusNow === "expired" ? (
                  <div className="flex justify-center w-full mx-auto mb-4 ">
                    <div className="p-4 text-center space-y-6">
                      ...
                      <RegenerateQrButton id={transaction.invoice} />
                    </div>
                  </div>
                ) : (
                  <>
                    ...
                    <div className="text-center text-md text-muted-foreground">
                      <p>selesaikan pembayaran kamu sebelum</p>
                      <p>{convertToLocalDate(transaction.expiredAt)}</p>
                    </div>
                  </>
                )}
              </CardContent>
                  ...
                  <div className="flex items-center justify-between w-full">
                    ...
                    <p className="text-sm font-medium">
                      {transaction?.createdAt &&
                        convertToLocalDate(transaction?.createdAt)}
                    </p>
                  </div>
                </div>
              </CardContent>
