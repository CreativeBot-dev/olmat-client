      ...
      <div className="mt-20">
        ...
        <Tabs defaultValue="Shopee" className="w-full">
          <div className=" flex justify-center mb-8">
            <TabsList className="grid grid-cols-2 w-full max-w-md glass-strong">
              <TabsTrigger
          ...
          <TabsContent value="Shopee">
            <div className="mb-7">
              <div className="flex gap-4 items-center font-bold text-xl text-white">
            ...
            >
              {APPCONSTANT.socialEcommerce.shopee.item.map((item, i) => (
                ...
                >
                  <Card className="overflow-hidden group border-none drop-shadow-md glass">
                    ...
                    <CardContent className="p-4 pt-2">
                      ...
                      <div className="grid lg:grid-cols-2 gap-3">
                        <Link
                          href={item.chat}
                          target="_blank"
                          className=" hover:bg-brandDark/20 text-brandLight hover:text-brandLight  border-brandLight w-full border flex items-center justify-center gap-2 px-4 py-2 rounded-md  duration-300"
                        >
                        ...
                        <Link
                          href={item.link}
                          target="_blank"
                          className="bg-brandLight hover:bg-brandDark/50 text-black hover:text-brandLight  border-brandLight w-full border flex items-center justify-center gap-2 px-4 py-2 rounded-md  duration-300"
                        >
