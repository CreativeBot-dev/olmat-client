...
export function TimelineSection() {
  ...
  return (
    ...
    >
      <Planet
        className="left-[6%] top-[28%] animate-float-medium hidden md:block"
        size={120}
        color="linear-gradient(135deg,#D8CE73,#4D4177)"
        glow="#D8CE73"
      />
      <Planet
        className="right-[8%] top-[22%] animate-float-slow hidden md:block"
        size={70}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg max-w-3xl mx-auto">
            <AppTitle>
              Catat tanggal penting OLMAT UINSA {APPCONSTANT.year}! Ikuti setiap
              tahapannya mulai dari pendaftaran hingga babak final dan raih
              prestasi terbaikmu.
            </AppTitle>
          </p>
        </div>
